...
| Domain | Phase | Description | Output |
|---|---|---|---|
| Business | **Strategy & Commission** | Business defines the strategic outcome: what problem to solve, what value to create, what constraints apply. It commissions the initiative and sets acceptance criteria — the conditions under which UAT will pass. | Initiative brief · Outcome criteria · Domain mandate |
| Products | **Translation & Design** | Product roles receive the Business mandate and translate it into architecture-ready requirements. Product designs the solution logic and shape, owns the backlog, and defines what Technology must build. | Requirements spec · Solution design · Delivery backlog |
