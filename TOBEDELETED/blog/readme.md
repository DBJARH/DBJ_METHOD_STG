...
- [Knighthood of Legacy Slayers](knighthood-of-legacy-slayers/knighthood-of-legacy-slayers.md)
  - She's still standing. The legacy system endures — and so must the discipline required to modernize it.
- [Modular monoliths are highly suitable for mainframe modernization](modular-monolith-for-mainframe/modular-monolith-for-mainframe.md)
  - Mainframes are already monolithic — modularizing in-place is less disruptive than immediate distribution. The path: Legacy Monolith → Modular Monolith → Selective Distribution, often achieving 30–60% MIPS reduction without leaving the mainframe.
