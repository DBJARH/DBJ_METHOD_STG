...
- [Capability Maturity Model (CMM)](#capability-maturity-model-cmm)
  ...
  - [ACMM as Foundational Capability for ADM](#acmm-as-foundational-capability-for-adm)
...
## ACMM as Foundational Capability for ADM

The Architecture Development Method (ADM) requires the hosting organisation to be at ACMM maturity level M3 or above. Deliverable quality is capability-gated by CMM foundations — effective ADM execution requires sufficient maturity across all nine dimensions.
...
Rather than immediately delivering architecture artifacts, effective engagement focuses on capability development first.
