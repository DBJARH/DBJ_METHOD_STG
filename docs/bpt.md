...
layout: default
title: The BPT Loop
description: Business, Product, Technology — the DBJ operational methodology governing continuous delivery.
---

## Why the BPT Loop

>The underlying idea of DBJ Method is to make simplified TOGAF artifacts, into the framework for feasible business management method.
{: .note}
...
* The core necessity of the BPT is to make the DBJ ADM products easy to digest and use by the three key segments of any organisation: 
  * Business
  * Product
  * Technology
...
The BPT Loop is the DBJ operational methodology 
...
- [DBJ ADM](kb/icl-adm/index.md) — the governance ADM (aka wheel) that operates above BPT
