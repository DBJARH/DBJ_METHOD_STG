---
Five Elements: What the five elements are and why they exist in every organization
Six levels: L0–L5 with names and descriptions
Characteristics: per element (4 each) as observable evidence criteria
Reference table: showing what each level looks like per element
Scoring rule: (minimum across all five elements) with an example
---
# ICL CMM

![ICLCMM](../assets/togaf_cmm_icl_simplified.png)

The ICL CMM describes organizational maturity in terms of **five** structural elements that exist in every organization regardless of size, industry, or whether dedicated EA practitioners are present:
